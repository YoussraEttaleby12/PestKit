     ...
     <div>
      <div className="sidebar">
        ...
        <div className="sidebar-menu">
          <ul>
          <li>
              <Link to="/client"  className="linkk">
                <span>  <AiOutlineFileDone className="iconn" />Dasboard</span>
              </Link>
            </li>
            <li>
              <Link to="/clientavi"  className="linkk">
               
                <span>  <AiOutlineFileDone className="iconn" /> Avis de passage</span>
              </Link>
            </li>
            <li>
              <Link to="/clientdoc" className="linkk">
                
                <span>  <FiFileText className="iconn" /> Documents</span>
              </Link>
            </li>
            <li>
              <Link to="/clientdem" className="linkk">
